    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="100%">
      ...
      <ForeignObject class="flex h-full flex-col flex-wrap justify-center">
        <ul class="flex flex-col gap-1 font-mono text-[11px] text-blue-700">
          <li
            class={cn(
              "mb-1 flex flex-row items-start gap-1 font-bold",
              mobile && "justify-center text-center",
            )}
          >
            {githubStat.username}.getStats()...
          </li>
          ...
          >
            <svg
              ...
              width="11"
              height="11"
              class="min-w-[11px] text-blue-700"
            >
              <path
                fill="currentColor"
                fill-rule="evenodd"
          ...
          >
            <svg
              ...
              width="10"
              height="10"
              class={cn("min-w-[11px] text-blue-700", mobile && "hidden")}
            >
              <path
                fill="currentColor"
            ...
            <div class="inline-block whitespace-normal break-words">
